...
public class UserController {
    ...
    public ModelAndView creatNewUser(@Validated @ModelAttribute("userList") User user, BindingResult bindingResult) throws DuplicateEmailException {
    ...
    public ModelAndView showInputNotAcceptable() {
        return new ModelAndView("user/viewException");
    }
